...
SDK.prototype.verifyScopes = function (scopesToken, scopes) {

	var matches = scopesToken.match(/[a-z]+:[a-z0-9*]*:[a-zA-Z0-9*]*/g);

	if (null !== matches) {
		if (matches.indexOf(scopes) >= 0 || null !== scopesToken.match(/[a-z]+::[*]+/g)) {
			return true;
		} else {
			return false;
		}
